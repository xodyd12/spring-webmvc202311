...
<div id="wrap">
    ...
    <div class="top-section">
        ...
        <div class="amount">
            <a href="/board/list?amount=6&type=${s.type}&keyword=${s.keyword}">6</a>
            <a href="/board/list?amount=18&type=${s.type}&keyword=${s.keyword}">18</a>
            <a href="/board/list?amount=30&type=${s.type}&keyword=${s.keyword}">30</a>
        </div>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination pagination-lg pagination-custom">
                ...
                <c:if test="${maker.page.pageNo != maker.finalPage}">
                    <li class="page-item"><a class="page-link" href="/board/list?pageNo=${maker.finalPage}&type=${s.type}&keyword=${s.keyword}&amount=${s.amount}">&gt;&gt;</a>
                    </li>
                </c:if>
            </ul>
        </nav>
