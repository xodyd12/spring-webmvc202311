...
@Controller // 빈 등록 : 이 클래스의 객체 생성관리는 스프링이 처리한다
public class ControllerV1 {
    ...
    // ==5. Post 요청 데이터 읽기
    // -> foods.jsp에서 보낸 데이터를 읽을 것임
    //나는 POST 로 오지 않으면 요청을 거절한다.
//    @RequestMapping(value = "foods-select", method = RequestMethod.POST)
    @PostMapping("foods-select")
