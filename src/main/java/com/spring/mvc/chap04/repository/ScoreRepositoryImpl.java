...
public class ScoreRepositoryImpl implements ScoreRepository {
    ...
    static {
        ...
        Score s1 = new Score("뽀로로", 100, 88, 33, ++seq, 0, 88.0, Grade.A);
        Score s2 = new Score("춘식이", 33, 99, 11, ++seq, 0, 44.0, Grade.D);
        Score s3 = new Score("쿠로미", 66, 55, 22, ++seq, 0, 66.0, Grade.C);
