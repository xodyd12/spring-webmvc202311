...
class BoardMapperTest {
    ...
    @Test
    @DisplayName("게시물을 조회 하면 301개의 게시물이 조회된다.")
    void findAllTest() {
        //given
    ...
    @Test
    @DisplayName("30번 게시물을 단일 조회하면 제목에 27이 포함 되어 있어야 한다.")
    void findOneTest() {
        //given
        int boardNo = 30;
        //when
        ...
        //then
        assertTrue(b.getTitle().contains("10"));
    }
    ...
    @Rollback
    void deleteTest () {
        //테스트는 몇번을 돌려도 같은 결과가 나오게 만들어야 함
        //given
        int boardNo = 29;
        //when
